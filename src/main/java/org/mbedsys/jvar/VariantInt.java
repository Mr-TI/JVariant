 ...
 */
public class VariantInt extends NumberVariant implements Comparable<Object>, FrameElement {
	 ...
	 */
	public VariantInt(ByteArrayInputStream input, int byteLength) {
		data = 0;
	 ...
	 * @param input ByteArrayInputStream
	 */
	public VariantInt(ByteArrayInputStream input) {
		this(input, 4);
	}
