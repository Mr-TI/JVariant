...
public class VariantList implements Variant, List<Variant> {
     ...
     *
     * @param variant element to be appended to this list
	...
	/**
	 * Remove a value from a list using it's index
	 * 
	 * Applicable to a list variant
	 * 
	 * @param index
	 *            the index
	 ...
	 */
	public boolean remove(Variant value) {
