 ...
 */
public class VariantLong extends NumberVariant implements Comparable<Object>, FrameElement {
	
	public static final Variant ZERO = new VariantLong(0);
	 ...
	 */
	public VariantLong(ByteArrayInputStream input, int byteLength) {
		data = 0;
	 ...
	 * @param input ByteArrayInputStream
	 */
	public VariantLong(ByteArrayInputStream input) {
		this(input, 8);
	}
