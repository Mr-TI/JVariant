 ...
 */
public class VariantUInt extends NumberVariant implements Comparable<Object>, FrameElement {

	public static final VariantInteger ZERO = new VariantInteger(0);
	 ...
	 */
	public VariantUInt(ByteArrayInputStream input, int byteLength) {
		data = 0;
	 ...
	 * @param input ByteArrayInputStream
	 */
	public VariantUInt(ByteArrayInputStream input) {
		this(input, 4);
	}
